...
The magnetometer is nearly a factor of ten noiser than the accelerometer, which explains the increased noise in the blue yaw trace, even when the sensor is  held still. Y scale is degrees.
